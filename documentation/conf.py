...
# sphinx-quickstart on Mon Jan  2 16:00:45 2012.
#
...
man_pages = [
    ('contents', 'pyrate', u'PyRate Documentation',
...
texinfo_documents = [
  ('contents', 'PyRate', u'PyRate Documentation',
   u'Joshua W. Allen, Yury V. Suleimanov, William H. Green', 'PyRate', 'One line description of project.',
   'Miscellaneous'),
]
